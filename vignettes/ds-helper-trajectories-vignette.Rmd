...
![plot of chunk plot-model-1-pooled](figure/plot-model-1-pooled-1.png)
...
![plot of chunk plot-model-1-cohort](figure/plot-model-1-cohort-1.png)
...
![plot of chunk plot-model-2](figure/plot-model-2-1.png)
...
##  4 age,logage      weight~1+ age+logage + (1|id_int)     
...
## 10 agem_2,logage   weight~1+ agem_2+logage + (1|id_int)
```
...
##  4 age,logage      FALSE     There are some DataSHIELD errors, list them with datashield.errors() NA           
...
## 10 agem_2,logage   FALSE     There are some DataSHIELD errors, list them with datashield.errors() NA           
## # ℹ 18 more rows
```
...
##  6 age,agem_0_5  -420377. -26508. -142164. -570741. -1159790.
##  7 age,agem_1    -420403. -26741. -143292. -570683. -1161119.
##  8 age,agem_2    -420409. -26825. -143753. -570701. -1161687.
##  9 age2,age3     -420299. -28151. -160084. -580176. -1188710.
## 10 agem_0_5,age2 -429885. -29926. -161971. -588452. -1210234.
## # ℹ 18 more rows
```
...
##  6 age2,age3     -420299.
##  7 age,agem_0_5  -420377.
##  8 age,agem_1    -420403.
##  9 age,agem_2    -420409.
## 10 agem_0_5,age2 -429885.
## # ℹ 18 more rows
```
...
![plot of chunk plot-model-3-pooled](figure/plot-model-3-pooled-1.png)
...
![plot of chunk plot-model-3-cohort](figure/plot-model-3-cohort-1.png)
