...
# Arguments:
#
# varlist: a vector of variable names
# df: an assigned dataframe containing the above variables
#
# Value:
#
...
full_var_names <- paste0(df, "$", varlist)
...
factors <- varlist[(which(f == TRUE))]
integers <- varlist[(which(i == TRUE))]
